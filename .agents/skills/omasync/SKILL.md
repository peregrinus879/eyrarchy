...
8. Cross-repo coordination: read the other host repository's ledger for items assigned to this repo and for stale entries describing this host's environment
